...
# Augmented xyz2mol to just get a proper networkx Graph object from xyz data
...
def setAromaticity(mol_graph):
    ...
    for b in basis:
        ...
        basis_edges = [(b[-1], b[0])] if b[0] > b[-1]  else [(b[0], b[-1])]
...
if __name__ == "__main__":
    ...
    AC, _ = xyz2AC(atoms, xyz_coordinates, charge, use_huckel=use_huckel)
